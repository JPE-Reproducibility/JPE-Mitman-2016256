...
%%
% IndustryBeg is the qdsbk1 counterpart of the Industry pairing.
% Produces paper tab:Benefits_on_unemp_beg Col 6 (industry<=.0440707).
...
%% Col 6: industry<=.0440707 subsample (qdsbk1 LHS at QBLS col 9)
p=1;
...
cd(SaveDir)
dlmwrite('SenseResultsIndustryBeg.csv',distresults);
