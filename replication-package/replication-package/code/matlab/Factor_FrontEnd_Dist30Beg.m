...
%%
% Dist30Beg is the qdsbk1 counterpart of the Dist30 pairing.
% Produces paper tab:Benefits_on_unemp_beg Col 7 (dist<30).
...
SepMethod='Dist30';	% Pick differencing method
...
%% Col 7: dist<30 subsample (qdsbk1 LHS at QBLS col 9)
p=1;
...
cd(SaveDir)
dlmwrite('SenseResultsDist30Beg.csv',distresults);
