...
%%
% EmpShareBeg is the qdsbk1 counterpart of the EmpShare pairing. Reads the
% same output/factor_inputs/EmpShare/QBLS*.txt files (extended to include
% qdsbk1_logunemp_rate_laus as col 9). Produces paper
% tab:Benefits_on_unemp_beg Col 5 (emp_share<0.15 subsample).
...
SepMethod='EmpShare';	% Pick differencing method
...
%% Col 5: emp_share<0.15 subsample (qdsbk1 LHS at QBLS col 9)
p=1;
...
cd(SaveDir)
dlmwrite('SenseResultsEmpShareBeg.csv',distresults);
