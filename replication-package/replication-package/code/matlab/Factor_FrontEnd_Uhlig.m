...
%%
SepMethod='Uhlig';	% Pick differencing method
...
% %%
% SepMethod='CBSA';	% Pick differencing method
% N = importdata([InputBaseDir SepMethod '/N.txt']);
% T=100;
% drop=60;
% trunc=8;
...
% 
% %%
% SepMethod='SHARE';	% Pick differencing method
% N = importdata([InputBaseDir SepMethod '/N.txt']);
% T=100;
% drop=60;
% trunc=8;
...
cd(SaveDir)
% filename matches the reader in code/tex/make_tables.py (Table 1, Col 11)
dlmwrite('Uhlig_qd1_unemp_drop60_trunc8_se.csv',distresults);
