...
%%
% CBSABeg is the qdsbk1 counterpart of the CBSA pairing.
% Produces paper tab:Benefits_on_unemp_beg Col 8 (samecbsa==1).
...
%% Col 8: samecbsa==1 subsample (qdsbk1 LHS at QBLS col 9)
p=1;
...
cd(SaveDir)
dlmwrite('SenseResultsCBSABeg.csv',distresults);
